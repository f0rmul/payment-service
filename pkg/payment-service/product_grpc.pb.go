...
func (UnimplementedProductServiceServer) GetProductByID(context.Context, *ProductByIDRequest) (*ProductByIDResponse, error) {
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/payment-service/product.proto",
}
